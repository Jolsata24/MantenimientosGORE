...
<body>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge <?php echo $badge_color; ?> border fw-normal"><?php echo $color_impresion; ?></span>
                                    </td>
                                    <td>
                                        <?php if (!empty($fila['ip']) && $fila['ip'] != '-'): ?>
                                            <span class="badge bg-light text-primary border font-monospace"><i class="fas fa-network-wired me-1"></i><?php echo $fila['ip']; ?></span>
                                        <?php else: ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            // Alertas (Actualizado para incluir 'deleted')
            ...
            if (status === 'updated') {
                Swal.fire({
                    icon: 'success',
                    title: 'Guardado',
                    text: 'Datos de impresora actualizados.',
                    timer: 2000,
