...
<head>
    ...
    <style>
        /* Ajuste para que las celdas no sean enormes */
        .table td { vertical-align: middle; font-size: 0.85rem; }
        .badge-spec { font-size: 0.75rem; font-weight: 500; }
        .text-truncate-2 {
            display: -webkit-box;
            -webkit-line-clamp: 2;
            -webkit-box-orient: vertical;
            overflow: hidden;
            max-width: 200px; /* Limite de ancho para ubicación */
        }
    </style>
</head>
<body>
...
<th><i class="fas fa-laptop"></i> Equipo / Nombre</th>
                        ...
                        <tbody>
                            <?php
                            // Solo traemos categoría 1 (Computadoras)
                                ...
                                <td>
                                    <div class="d-flex flex-column gap-1">
                                        ...
                                        <div class="d-flex gap-1">
                                            <span class="badge bg-success bg-opacity-10 text-success border border-success px-2" title="Memoria RAM">
                                                RAM: <?php echo !empty($fila['ram']) ? $fila['ram'] : '-'; ?>
                                            </span>
                                            <span class="badge bg-primary bg-opacity-10 text-primary border border-primary px-2" title="Disco Duro">
                                ...
                                <td class="text-center">
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end shadow">
                                            ...
                                            <li><a class="dropdown-item" href="phpqrcode.php?id=<?php echo $fila['id_bien']; ?>" target="_blank"><i class="fas fa-qrcode text-dark me-2"></i>Imprimir QR</a></li>
                                        </ul>
                                    </div>
                                </td>
                            </tr>
    ...
    <script> 
        $(document).ready(function() { 
            $('#tablaComputo').DataTable({ 
                ...
                pageLength: 10, 
                ordering: false, 
                responsive: true // Hace que se adapte a moviles
            }); 
        }); 
    </script>
</body>
